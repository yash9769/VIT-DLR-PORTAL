...
export default function HistoryPage() {
  ...
  const startEdit = (recData) => {
    ...
    setEditForm({
      ...
      remarks: rec.remarks || '',
      lcs_status: rec.lcs_status || 'not_covered',
      smartboard_pdf_uploaded: Boolean(rec.smartboard_pdf_uploaded),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData = {
        ...
        subtopics: rest.subtopics || null,
        unit_number: rest.unit_number !== '' ? Number(rest.unit_number) : null,
        remarks: rest.remarks || null,
        lcs_status: rest.lcs_status || 'not_covered',
        smartboard_pdf_uploaded: Boolean(rest.smartboard_pdf_uploaded),
        actual_from: sanitized.actual_from || null,
        actual_to: sanitized.actual_to || null,
        timetable_from: sanitized.timetable_from || null,
        timetable_to: sanitized.timetable_to || null,
        present_count: Number(editForm.present_count) || 0,
        total_students: Number(editForm.total_students) || 0,
        absent_count: (Number(editForm.total_students) || 0) - (Number(editForm.present_count) || 0),
