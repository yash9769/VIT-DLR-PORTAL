...
import { LayoutDashboard, FileText, Users, History, Bell, LogOut, ChevronRight, LifeBuoy, User, Calendar, X } from 'lucide-react'
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button 
                        ...
                        className="w-6 h-6 rounded-lg flex items-center justify-center bg-slate-100 hover:bg-indigo-600 hover:text-white text-slate-400 transition-all opacity-100 sm:opacity-0 group-hover:opacity-100"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </div>
