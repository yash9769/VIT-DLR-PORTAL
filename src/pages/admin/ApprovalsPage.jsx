    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          ...
          lcs_status, smartboard_pdf_uploaded, 
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                ['Attendance Summary', `${viewing.present_count ?? viewing.attendance ?? 0} / ${viewing.total_students ?? viewing.total_batch_strength ?? 60} (${attendancePercent(viewing.present_count ?? viewing.attendance ?? 0, viewing.total_students ?? viewing.total_batch_strength ?? 60)}%)`],
